...
while True:
    ...
    # face_locations = face_recognition.face_locations(frame, model="cnn")  # con el modelo CNN
    face_locations = face_recognition.face_locations(frame) # Con el modelo por defecto
    if face_locations != []:
